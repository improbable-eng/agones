...
type GameServerSetInterface interface {
	...
	GetScale(ctx context.Context, gameServerSetName string, options metav1.GetOptions) (*v1beta1.Scale, error)
	UpdateScale(ctx context.Context, gameServerSetName string, scale *v1beta1.Scale, opts metav1.UpdateOptions) (*v1beta1.Scale, error)
...
func (c *gameServerSets) GetScale(ctx context.Context, gameServerSetName string, options metav1.GetOptions) (result *v1beta1.Scale, err error) {
...
func (c *gameServerSets) UpdateScale(ctx context.Context, gameServerSetName string, scale *v1beta1.Scale, opts metav1.UpdateOptions) (result *v1beta1.Scale, err error) {
	result = &v1beta1.Scale{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gameserversets").
