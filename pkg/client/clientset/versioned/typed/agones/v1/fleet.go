...
type FleetInterface interface {
	...
	GetScale(ctx context.Context, fleetName string, options metav1.GetOptions) (*v1beta1.Scale, error)
	UpdateScale(ctx context.Context, fleetName string, scale *v1beta1.Scale, opts metav1.UpdateOptions) (*v1beta1.Scale, error)
...
func (c *fleets) GetScale(ctx context.Context, fleetName string, options metav1.GetOptions) (result *v1beta1.Scale, err error) {
...
func (c *fleets) UpdateScale(ctx context.Context, fleetName string, scale *v1beta1.Scale, opts metav1.UpdateOptions) (result *v1beta1.Scale, err error) {
	result = &v1beta1.Scale{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("fleets").
