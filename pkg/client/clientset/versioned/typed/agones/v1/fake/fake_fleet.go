...
func (c *FakeFleets) GetScale(ctx context.Context, fleetName string, options v1.GetOptions) (result *v1beta1.Scale, err error) {
	obj, err := c.Fake.
...
func (c *FakeFleets) UpdateScale(ctx context.Context, fleetName string, scale *v1beta1.Scale, opts v1.UpdateOptions) (result *v1beta1.Scale, err error) {
	obj, err := c.Fake.
